...
var _vueSliderComponent = __webpack_require__(116);
...
function switchToHourlyView(index) {
  var hourData = loadHourlyData(index); // -1 because all-day is zero.
  ...
  fetch(url).then(function (resp) {
    ...
    try {
      for (var _iterator5 = json[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
        ...
        cachedHourlyData[_day][time_index]['dropoffs'][taz] = 3 * dropoff; // 3*cheating to make colors pop
        cachedHourlyData[_day][time_index]['pickups'][taz] = 3 * pickup;
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(113), __webpack_require__(299)))
