  ...
  fetch(url).then(function (resp) {
    ...
    try {
      for (var _iterator5 = json[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
        ...
        cachedHourlyData[_day][time_index]['dropoffs'][taz] = 8 * dropoff; // 3*cheating to make colors pop
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(85), __webpack_require__(300)))
